...
@section('conteudo')
    ...
    <div id="div_form" class="container">
        ...
        <form id="form_new_prod" name="form_new_prod" method="post" action="/produtos/makeupdate/<?= $id?>">
        
            <input type="hidden" name="_token" value="{{{ csrf_token() }}}">

            <div class="form-group">
                <label>Nome do Produto</label>
                <input type="text" id="inputProdName" name="inputProdName" class="form-control" value="">
            </div>
